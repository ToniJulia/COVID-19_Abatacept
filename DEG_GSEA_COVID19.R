...
raw_cts <- read.table("Source_data/COVID19_cts.tsv", sep="\t", header=T, stringsAsFactors=F)
...
saveRDS(res, file=paste0("DEG/COVID19_DEG.RDS"))
...
saveRDS(edo, file=paste0("GSEA/COVID19_GSEA.RDS"))
